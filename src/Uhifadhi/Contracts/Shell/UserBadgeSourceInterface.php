 ...
 *
 * Note the shape of the question, and that it mirrors the area seam's: the shell
 ...
 * all not the package that defines a user, so this seam cannot traffic in a
 ...
 * same argument the nav seam uses.
 *
 ...
 *
 * A host or a battery module points the shell at its implementation by aliasing
