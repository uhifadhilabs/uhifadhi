...
/**
 * ONE ROW OF "NEEDS ATTENTION" — the area page owns the list, a module owns the item.
 *
 * The area overview's attention list is not a list the area page wrote. Every row is
 ...
 * entered. The area page merges them, sorts them by urgency and draws them all
 * identically. That is the whole point of the registry — the area page does not know what
 ...
 * raised it is dealt with, because the area page never stored it: the aggregator asks
...
final readonly class AttentionItem
{
     ...
     *                                 ("live position", "past term", "coverage gap") — the area page prints it
     ...
     * @param int          $ageSeconds the same age as a number, so the area page can sort within a severity
