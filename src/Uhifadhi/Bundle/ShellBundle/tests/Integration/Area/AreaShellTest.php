 ...
 * strip has no behaviour to own: it is markup plus a rule about lighting, and
 * carving it into a bundle of its own would only give the shell something to
 * require — and the shell requires nothing it renders.
