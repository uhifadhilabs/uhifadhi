...
namespace Uhifadhi\Bundle\ShellBundle\Widget\Model;
...
final readonly class Widget
{
     ...
     *
     * A NOTE MAY BE COMPOSED RATHER THAN WRITTEN. A surface whose widgets
     * summarise what OTHER modules contributed cannot write the true line when
     * it declares the widget — it does not yet know what is installed. So the
     * code assembling the catalogue swaps a fuller sentence in as it builds the
     * list, and the declaration stays what the surface can say ALONE. This only
     * ever makes a line longer and truer.
     */
